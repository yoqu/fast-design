/**
 * Truncation-tolerant JSON parsing for streamed LLM output — 1:1 port of
 * open-design apps/web/src/runtime/partial-json.ts. The streaming
 * `<question-form>` discovery form needs to render a JSON *prefix* that grows
 * one token at a time, so it uses this repair pass.
 *
